export default {
  ...
  "schedules": {
    ...
    "attendance_nudge_today_single": "Starts today at {{time}}",
    "attendance_nudge_tomorrow_single": "Starts tomorrow at {{time}}",
    "attendance_nudge_today": "The next one starts today at {{time}}",
    "attendance_nudge_tomorrow": "The next one starts tomorrow at {{time}}",
    "attendance_nudge_subtitle": "Tap to confirm",
