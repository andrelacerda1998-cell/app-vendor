export default {
  ...
  "schedules": {
    ...
    "attendance_nudge_today_single": "It's today at {{time}}",
    "attendance_nudge_tomorrow_single": "It's tomorrow at {{time}}",
    "attendance_nudge_today": "The next one is today at {{time}}",
    "attendance_nudge_tomorrow": "The next one is tomorrow at {{time}}",
