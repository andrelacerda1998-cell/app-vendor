export default {
  ...
  "services": {
    ...
    "service": {
      ...
      "status": {
        ...
        "distance": "Distance",
        "value_is_yours": "Yours, no deductions",
  ...
  "service_extras": {
    ...
    "add_time_hint": "The client has to approve before the time counts towards the service.",
    "add_part_title": "Add part/material",
    "add_part_hint": "The client has to accept the cost before the part is added to the service value.",
    "part_label": "What you need",
    "value_label": "Part cost",
  ...
  "documents_help": {
    ...
    "at": {
      ...
      "description": "Create a sub-user on the tax portal with permission to report invoices and sequences, and enter the details here — Piquet uses it to report your services to the tax authority.",
                  "steps_title": "How to create the sub-user",
            "step_1": "Sign in to the Portal das Finanças with your NIF and password.",
            "step_2": "Go to Todos os Serviços and look for Gestão de Utilizadores (under Autenticação de Contribuintes).",
            "step_3": "Create a new user and set a password for it.",
            "step_4": "Grant it the Comunicação de Dados de Faturas (WFA) and Comunicação de Séries Documentais (WSE) permissions.",
            "step_5": "Save. The user will look like NIF/number — for example 123456789/1.",
            "step_6": "Enter that user and the password you set for it here.",
            "open_portal": "Open the Portal das Finanças",
"user_label": "Tax Authority sub-user",
  ...
  "complete_profile": {
    ...
    "cities": {
      ...
      "min_progress": "{{count}} of 3 minimum",
            ...
            "no_suggestions": "Use the search above to find your cities.",
  ...
  "schedules": {
    ...
    "call_customer": "Call the client",
    "call_unavailable": {
      "title": "Contact unavailable",
      "subtitle": "We don't have the client's number yet. Please try again later."
    },
    "date_label": {
      "today": "Today",
      "tomorrow": "Tomorrow",
    ...
    "now": "Now",
    "immediate": "Immediate",
    "service_scheduled": "Scheduled service",
    ...
    "screen_subtitle": "The customer picks from the first 3 to reply. Your calendar is only taken if you're chosen.",
        "when_label": "When",
        ...
        "accepted_step_choose": "The client picks from the candidates.",
