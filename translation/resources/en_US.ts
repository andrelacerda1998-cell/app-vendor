  ...
  "schedules": {
    ...
    "matching": {
      "invitation": {
        ...
        "accept_all_confirm_title": "Accept all requests?",
        "accept_all_confirm_subtitle": "You'll be on the list for all {{count}} requests. Your calendar is only booked for the ones you're chosen for.",
        "accept_all_confirm_cta": "Accept all",
        "accept_all_cancel": "Cancel",
