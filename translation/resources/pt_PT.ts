export default {
    ...
    "schedules": {
      ...
      "attendance_nudge_today_single": "É hoje às {{time}}",
      "attendance_nudge_tomorrow_single": "É amanhã às {{time}}",
      "attendance_nudge_today": "O próximo é hoje às {{time}}",
      "attendance_nudge_tomorrow": "O próximo é amanhã às {{time}}",
