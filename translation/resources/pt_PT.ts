export default {
    ...
    "general": {
        ...
        "password_uppercase": "Tem de ter pelo menos uma letra maiúscula",
        "password_lowercase": "Tem de ter pelo menos uma letra minúscula",
        "password_number": "Tem de ter pelo menos um número",
        "password_special_character": "Tem de ter pelo menos um símbolo (!, @, #…)",
        "password_common": "Não pode ser uma palavra-passe demasiado comum",
