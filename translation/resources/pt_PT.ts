export default {
    ...
    "schedules": {
      ...
      "attendance_nudge_today_single": "Começa hoje às {{time}}",
      "attendance_nudge_tomorrow_single": "Começa amanhã às {{time}}",
      "attendance_nudge_today": "O mais próximo começa hoje às {{time}}",
      "attendance_nudge_tomorrow": "O mais próximo começa amanhã às {{time}}",
      "attendance_nudge_subtitle": "Toca para confirmar",
