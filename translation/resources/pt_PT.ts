export default {
        ...
        "service": {
            ...
            "status": {
                ...
                "countdown": {
                    ...
                    "need_more_time": "Precisas de mais tempo?"
                },
                "stuck": {
    ...
    "profile": {
        ...
        "my_profile": {
            ...
            "labels": {
                ...
                "city_survey": "Expansão do Piquet",
    ...
    "service_extras": {
        ...
        "add_time_hint": "O cliente tem de aprovar antes de o tempo contar para o serviço.",
        "add_part_title": "Adicionar peça/material",
        "add_part_hint": "O cliente tem de aceitar o custo antes de a peça entrar no valor do serviço.",
        "part_label": "O que precisas",
        "value_label": "Custo da peça",
    ...
    "documents_help": {
        ...
        "at": {
            ...
            "description": "Cria um subutilizador no Portal das Finanças com permissão para comunicar faturas e séries, e indica aqui os dados — é com ele que a Piquet comunica os teus serviços à AT.",
                        "steps_title": "Como criar o subutilizador",
            "step_1": "Entra no Portal das Finanças com o teu NIF e senha de acesso.",
            "step_2": "Vai a Todos os Serviços e procura Gestão de Utilizadores (em Autenticação de Contribuintes).",
            "step_3": "Cria um novo utilizador e define-lhe uma palavra-passe.",
            "step_4": "Dá-lhe as permissões de Comunicação de Dados de Faturas (WFA) e Comunicação de Séries Documentais (WSE).",
            "step_5": "Guarda. O utilizador fica no formato NIF/número — por exemplo 123456789/1.",
            "step_6": "Escreve aqui esse utilizador e a palavra-passe que lhe definiste.",
...
"user_label": "Subutilizador AT",
    ...
    "complete_profile": {
        ...
        "cities": {
            ...
            "no_suggestions": "Usa a pesquisa acima para encontrares as tuas cidades.",
    ...
    "matching": {
      "invitation": {
        ...
        "screen_subtitle": "O cliente escolhe entre os 3 primeiros a responder. Só ocupas a agenda se fores escolhido.",
        "when_label": "Quando",
        ...
        "accepted_step_choose": "O cliente escolhe entre os candidatos.",
